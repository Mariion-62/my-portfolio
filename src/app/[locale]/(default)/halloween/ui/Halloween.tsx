...
export default function Halloween(): ReactElement {
  ...
  const handlePrevious = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 1 + dataHalloween.length) % dataHalloween.length)
    setIsAnswerVisible(false)
  }
    ...
    <div className={styles.halloween_page}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.container_button}>
          <button className={styles.button_prev_next} onClick={handlePrevious} disabled={currentIndex === 0}>
