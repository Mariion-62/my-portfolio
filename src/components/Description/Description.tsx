  ...
  return (
    <div className={styles.containerDescription}>
      <p className={styles.contentDescription}>
        ...
        autonome, investie, dynamique. J’aime voyager, jouer au jeux vidéo, aux
        jeux de société, aller en concert, en festival mais aussi me poser
        ...
        décidé de faire une reconversion dans le domaine de l’IT pour me donner
        un nouveau challenge et m&apos; épanouir en tant que développeuse.
      </p>
